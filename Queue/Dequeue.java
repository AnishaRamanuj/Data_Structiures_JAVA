/*
The algorithm to dequeue an element from a queue is as follows:

1. Check whether the queue is empty.
2. If the queue is empty, return appropriate message
3. If the queue is not empty,
4.    Retrieve data at the front of the queue
5.    Increment front by 1
6.    Return the retrieved element
=========================================================================================================
The complete implementation of Queue class is given below.

Display method is updated to ensure that the isEmpty method is called before displaying the elements.
